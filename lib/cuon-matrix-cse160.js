...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let i = other1.elements[1] * other2.elements[2] - other2.elements[1] * other1.elements[2];
        let j = other2.elements[0] * other1.elements[2] - other1.elements[0] * other2.elements[2];
        let k = other1.elements[0] * other2.elements[1] - other2.elements[0] * other1.elements[1];
